...
// Table layout / no-horizontal-overflow is now owned by the dedicated visual
// sweep e2e/listings-visual.spec.ts (every width × theme × view, measured on the
// wrapper) — it supersedes the old document-only overflow check that lived here
// and missed the wrapper-spill + header-collision the operator actually saw.
